...
type Rental struct {
	...
	NoInvoice             string                    `gorm:"column:no_invoice;not null;index"`
	...
	Status                constant.RentalStatus     `gorm:"column:status;type:varchar(20);not null;default:'pending'"`
	VehicleConditionStart constant.VehicleCondition `gorm:"column:vehicle_condition_start;type:text"`
	VehicleConditionEnd   constant.VehicleCondition `gorm:"column:vehicle_condition_end;type:text"`
